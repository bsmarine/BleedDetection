...
class FPN(nn.Module):
    ...
    def __init__(self, cf, conv, operate_stride1=False):
        ...
        self.start_filts = cf.start_filts # originally defined as 18
        ...
        # cf.end_filts = start_filts * 2 (i.e. 36 originally)
    ...
    def forward(self, x):
        ...
        #SE_layer1_out = self.SE_block(c4_out)
        
        #c5_out = self.C5(SE_layer1_out)
        ...
        if self.cX_out_bool:
            print("Inserted SE MODULES: cX_out")
