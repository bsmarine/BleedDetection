...
class FPN(nn.Module):
    ...
    def __init__(self, cf, conv, operate_stride1=False):
        ...
        self.SE_block = SE.ProjectExciteLayer(self.num_channels, self.SE_reduction_ratio)
        ...
        # self.SE_layer1 = SE_block(num_channels, SE_reduction_ratio)
    ...
    def forward(self, x):
        ...
        # print('\nFrom backbone.py, following is c0_out, c1_out, c2_out, c3_out, c4_out, c5_out:')
        ...
        #print('\nFollowing is p5_out, p4_out, p3_out, p2_out:')
